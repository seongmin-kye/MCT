...
class Runner(object):
            ...
            for i in range(nb_key):
                ...
                for idx, key in enumerate(key_list):
                    ...
                    if iter == 0:
                        ...
                        protomap = self.add_query(support_set, query_set, prob_list[iter - 1], nb_class)
    ...
    def train(self, images, labels):
        ...
        weight_idx = list(labels[:nb_class])
        labels = tuple([i for i in range(nb_class)]) * (self.n_query)
        ...
        loss_instance = self.loss(-distance, labels)
